...
class TriviaThree extends React.Component {
    ...
    state ={
        questions: [
            ...
            {q: "A website cannot be created without CSS.", a1: "True", a2: "False", a3: "", a4: "", c: "False"},
            {q: "What is the CSS selector that selects links on mouse over?", a1: "a:link", a2: "a::select", a3: "a:mouseOver", a4: "a:hover", c: "a:hover"},
            {q: "What is the correct CSS syntax to center the text within an element.", a1: "{text-align: center;}", a2: "{align: center;}", a3: "{align-text: center;}", a4: "{text: center;}", c: "{text-align: center;}"},
